...
if(is_array($result)) {
    ...
    foreach ($result as $r) {
        ...
        echo "<p>
                <a href='index.php?p=" . $url_page . "&category_level_1_id=" . $category_level_1_id . "&action=update' title='éditer cette entrée' class='bt-action'><i class=\"far fa-edit\"></i></a> 
                <a href='index.php?p=" . $url_page . "&category_level_1_id=" . $category_level_1_id . "&action=showHide' title='" . $txt_title . "' class='bt-action'>" . $txt_visible . "</a> 
                " . $txt_nom . " 
            </p>";
